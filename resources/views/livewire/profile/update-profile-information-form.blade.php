...
<section>
    ...
    <x-form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        <div>
            <x-input label="Nama Lengkap" wire:model="name" placeholder="Masukkan nama lengkap" id="name" name="name"
        ...
        <div>
            <x-input label="Email" wire:model="email" placeholder="Masukkan email" id="email" name="email"
                type="email" autofocus autocomplete="email" disabled />
        ...
        <div class="flex items-center gap-4">
            <x-button label="Simpan" class="btn-primary" type="submit" wire:click="updateProfileInformation" spinner />
        </div>
    </x-form>
</section>
